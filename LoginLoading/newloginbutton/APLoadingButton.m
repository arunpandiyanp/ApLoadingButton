...
@property (nonatomic, strong) ApAnimationCompletion animationCompletion;

@property (nonatomic, strong) APLoadingButton * animationButton;


@property (nonatomic, strong) UIColor *color;

@property (nonatomic, strong) APSpinLayer *spinerLayer;


@end

@implementation APLoadingButton
...
-(instancetype) initWithFrame:(CGRect)frame {
        ...
        if (self) {
            ...
            _spinerLayer = [[APSpinLayer alloc] initWithFrame:self.frame];
